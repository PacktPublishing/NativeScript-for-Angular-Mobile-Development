...
+ (NSString * _Nullable)createFileWithDir:(enum BaseDirectory)dir file:(NSString * _Nonnull)path write:(BOOL)write error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, BaseDirectory) {
/// Temporary directory
  BaseDirectoryTemp = 0,
/// Documents directory
  BaseDirectoryDocuments = 1,
/// Resources directory
  BaseDirectoryResources = 2,
/// Same directory as the input file
  BaseDirectoryCustom = 3,
};
...
/// \param samples the number of samples to generate (equals length in seconds multiplied by sample rate)
///
/// \param baseDir where the file will be located, can be set to .resources,  .documents or .temp
///
/// \param name the name of the file without its extension (String).
///
///
/// returns:
/// An AKAudioFile, or nil if init failed.
+ (AKAudioFile * _Nullable)silentWithSamples:(int64_t)samples baseDir:(enum BaseDirectory)baseDir name:(NSString * _Nonnull)name error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end


@interface AKAudioFile (SWIFT_EXTENSION(AudioKit))
/// Opens a file for reading.
/// \param name Filename, including the extension
///
/// \param baseDir Location of file, can be set to .Resources, .Documents or .Temp
///
///
/// returns:
/// An initialized AKAudioFile for reading, or nil if init failed
- (nullable instancetype)initWithReadFileName:(NSString * _Nonnull)name baseDir:(enum BaseDirectory)baseDir error:(NSError * _Nullable * _Nullable)error;
...
/// \param name the name of the file without its extension (String).
///
/// \param ext the extension of the file without “.” (String).
///
/// \param baseDir where the file will be located, can be set to .Resources, .Documents or .Temp
///
/// \param settings The settings of the file to create.
...
/// \param format The processing commonFormat to use when writing.
///
/// \param interleaved Bool (Whether to use an interleaved processing format.)
///
- (nullable instancetype)initWithWriteIn:(enum BaseDirectory)baseDir name:(NSString * _Nullable)name settings:(NSDictionary<NSString *, id> * _Nonnull)settings error:(NSError * _Nullable * _Nullable)error;
...
/// \param floatsArrays An array of Arrays of floats
///
/// \param name the name of the file without its extension (String).
///
/// \param baseDir where the file will be located, can be set to .resources,  .documents or .temp
...
- (nullable instancetype)initWithCreateFileFromFloats:(NSArray<NSArray<NSNumber *> *> * _Nonnull)floatsArrays baseDir:(enum BaseDirectory)baseDir name:(NSString * _Nonnull)name error:(NSError * _Nullable * _Nullable)error;
/// Convenience init to instantiate a file from an AVAudioPCMBuffer.
/// \param buffer the :AVAudioPCMBuffer that will be used to fill the AKAudioFile
///
/// \param baseDir where the file will be located, can be set to .Resources, .Documents or .Temp
///
/// \param name the name of the file without its extension (String).
...
/// returns:
/// a .caf AKAudioFile set to AudioKit settings (32 bits float @ 44100 Hz)
- (nullable instancetype)initFromAVAudioPCMBuffer:(AVAudioPCMBuffer * _Nonnull)buffer baseDir:(enum BaseDirectory)baseDir name:(NSString * _Nonnull)name error:(NSError * _Nullable * _Nullable)error;
@end
...
/// \param baseDir where the file will be located, can be set to .resources,  .documents or .temp
///
/// \param name the name of the file without its extension (String).  If none is given, a unique random name is used.
///
/// \param newMaxLevel max level targeted as a Float value (default if 0 dB)
///
///
/// returns:
/// An AKAudioFile, or nil if init failed.
- (AKAudioFile * _Nullable)normalizedWithBaseDir:(enum BaseDirectory)baseDir name:(NSString * _Nonnull)name newMaxLevel:(float)newMaxLevel error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// An AKAudioFile, or nil if init failed.
- (AKAudioFile * _Nullable)reversedWithBaseDir:(enum BaseDirectory)baseDir name:(NSString * _Nonnull)name error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
...
/// \param file an AKAudioFile that will be used to append audio from.
///
/// \param baseDir where the file will be located, can be set to .Resources, .Documents or .Temp
///
/// \param name the name of the file without its extension (String).  If none is given, a unique random name is used.
...
/// returns:
/// An AKAudioFile, or nil if init failed.
- (AKAudioFile * _Nullable)appendedByFile:(AKAudioFile * _Nonnull)file baseDir:(enum BaseDirectory)baseDir name:(NSString * _Nonnull)name error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
/// Returns an AKAudioFile that will contain a range of samples from the current AKAudioFile
/// \param fromSample the starting sampleFrame for extraction.
///
/// \param toSample the ending sampleFrame for extraction
///
/// \param baseDir where the file will be located, can be set to .Resources, .Documents or .Temp
///
/// \param name the name of the file without its extension (String).  If none is given, a unique random name is used.
...
/// returns:
/// An AKAudioFile, or nil if init failed.
- (AKAudioFile * _Nullable)extractedFromSample:(int64_t)fromSample toSample:(int64_t)toSample baseDir:(enum BaseDirectory)baseDir name:(NSString * _Nonnull)name error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
enum ExportFormat : NSInteger;
@class NSError;

@interface AKAudioFile (SWIFT_EXTENSION(AudioKit))
+ (CFStringRef _Nonnull)stringUTIWithType:(enum ExportFormat)type SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSArray<NSString *> * _Nonnull supportedFileExtensions;)
+ (NSArray<NSString *> * _Nonnull)supportedFileExtensions SWIFT_WARN_UNUSED_RESULT;
...
///
/// \endcodein this callback, you can check that process succeeded by testing processedFile value :
...
/// }
///
/// \endcode\param completionHandler the callback that will be triggered when process has been completed
///
/// \param baseDir where the file will be located, can be set to .Resources, .Documents or .Temp (Default is .Temp)
///
/// \param name the name of the resulting file without its extension (String).
///
/// \param newMaxLevel max level targeted as a Float value (default if 0 dB)
///
/// \param completionCallBack AKCallback that will be triggered as soon as process has been completed or failed.
///
- (void)normalizeAsynchronouslyWithBaseDir:(enum BaseDirectory)baseDir name:(NSString * _Nonnull)name newMaxLevel:(float)newMaxLevel completionHandler:(void (^ _Nonnull)(AKAudioFile * _Nullable, NSError * _Nullable))completionHandler;
...
/// \param completionCallBack AKCallback that will be triggered as soon as process has been completed or failed.
///
- (void)reverseAsynchronouslyWithBaseDir:(enum BaseDirectory)baseDir name:(NSString * _Nonnull)name completionHandler:(void (^ _Nonnull)(AKAudioFile * _Nullable, NSError * _Nullable))completionHandler;
...
/// \param completionCallBack AKCallback that will be triggered as soon as process has been completed or failed.
///
- (void)appendAsynchronouslyWithFile:(AKAudioFile * _Nonnull)file baseDir:(enum BaseDirectory)baseDir name:(NSString * _Nonnull)name completionHandler:(void (^ _Nonnull)(AKAudioFile * _Nullable, NSError * _Nullable))completionHandler;
...
/// \endcode\param completionHandler the callback that will be triggered when process has been completed
///
/// \param fromSample the starting sampleFrame for extraction. (default is zero)
///
/// \param toSample the ending sampleFrame for extraction (default is zero)
///
/// \param baseDir where the file will be located, can be set to .resources,  .documents or .temp (Default is .temp)
///
/// \param name the name of the resulting file without its extension (String).
...
/// \param completionCallBack AKCallback that will be triggered as soon as process has been completed or failed.
///
- (void)extractAsynchronouslyFromSample:(int64_t)fromSample toSample:(int64_t)toSample baseDir:(enum BaseDirectory)baseDir name:(NSString * _Nonnull)name completionHandler:(void (^ _Nonnull)(AKAudioFile * _Nullable, NSError * _Nullable))completionHandler;
...
/// \param name the name of the exported file without its extension (String).
///
/// \param baseDir where the file will be located, can be set to .resources,  .documents or .temp
///
/// \param ExportFormat the output file format as an ExportFormat enum value (.aif, .wav, .m4a, .mp4, .caf)
///
/// \param fromSample start range in samples
///
/// \param toSample end range time in samples
///
/// \param callback AsyncProcessCallback function that will be triggered when export completed.
///
- (void)exportAsynchronouslyWithName:(NSString * _Nonnull)name baseDir:(enum BaseDirectory)baseDir exportFormat:(enum ExportFormat)exportFormat fromSample:(int64_t)fromSample toSample:(int64_t)toSample callback:(void (^ _Nonnull)(AKAudioFile * _Nullable, NSError * _Nullable))callback;
@end
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, ExportFormat) {
