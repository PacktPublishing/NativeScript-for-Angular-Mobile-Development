...
import { IRecordModel, IRecordEvents, documentsFilePath } from './record-common.model';
...
export class RecordModel extends Observable implements IRecordModel {
  ...
  public set state(value: number) {
    ...
    this._store.dispatch(RecordActions.getStateAction(value));
  }
  ...
  public toggleRecord() {
    if (this._state !== RecordState.recording) {
      ...
      if (this._state !== RecordState.readyToRecord) {
        // just force ready to record if not already on it
